...
- `reproducibility/scripts/audit_reconciliation_20220407.py`
...
- `reproducibility/scripts/qa_conservative_reconciliation.py`
- `reproducibility/scripts/recalibrate_hls_fvc.py`
- `reproducibility/scripts/run_et_prediction.py`
...
- `reproducibility/scripts/smoke_test_spatial_prediction.py`
- `reproducibility/scripts/summarize_availability_diagnostic.py`
- `reproducibility/scripts/summarize_thermal_availability.py`
- `reproducibility/scripts/train_final_ridge25.py`
- `reproducibility/scripts/train_s2_kc_models.py`
- `reproducibility/scripts/validate_field_downscaling.py`

The production pipeline must not call scripts in the reproducibility section.
