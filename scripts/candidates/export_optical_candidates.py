...
def main(argv=None):
    ...
    from et_downscaling.optical_candidates import (
    ...
    import ee
    from et_downscaling.predictor_availability import (
    ...
    from et_downscaling.optical_candidates import build_paired_optical_table
