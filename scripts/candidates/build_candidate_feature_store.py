...
def build_store(root):
    ...
    s1_path = paths.s1_root / "raw" / "s1_geometry_predictors.csv"
    thermal_path = paths.thermal_root / "raw" / "landsat_lst_station_period.csv"
    meteorology_path = paths.meteorology_root / "processed" / "period_meteorology.csv"
...
def predictor_metadata():
    ...
    add(
        ...
        "optical/raw/paired_optical_common.csv", "evaluated",
    ...
    add(
        ...
        "COPERNICUS/S2_SR_HARMONIZED", "10-20 m native; 20 m composite grid",
        "Mean over MODIS footprint", "MODIS-period temporal medoid",
        "optical/raw/s2_rich_optical.csv", "evaluated_ablation",
    ...
    for orbit, geometry in (("077", "ascending R077"), ("142", "descending R142")):
        add(
            ...
            "sentinel1/raw/s1_geometry_predictors.csv", "evaluated",
    ...
    add(
        ...
        "meteorology/processed/period_meteorology.csv", "partly_evaluated",
    ...
    add(
        ...
        "meteorology/processed/period_meteorology.csv", "available_not_evaluated",
    ...
    add(
        ...
        "meteorology/processed/period_meteorology.csv", "available_not_primary_predictor",
        "candidate", False, "Not included in the current wall-to-wall predictor stack", False,
    ...
    for column in store.columns:
        if column in metadata:
            ...
            row = {
                ...
                "current_local_file": "candidate feature-store join inputs",
                "conceptually_available": True,
...
def main():
    ...
    manifest = {
        "archive": "2020_2024_candidate_predictor_feature_store",
        "key": KEYS,
        "rows": len(store),
