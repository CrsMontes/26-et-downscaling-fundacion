...
def method_manifest():
    ...
    from et_downscaling.thermal_candidates import configuration_manifest
...
def adaptive_export(
    *, builder, modis_inputs, collection, start, end, chunk_dir,
    ...
    from et_downscaling.thermal_candidates import split_partition
...
def main(argv=None):
    ...
    import ee
    from et_downscaling.predictor_availability import get_dynamic_modis_inputs
    from et_downscaling.export import export_feature_collection
    from et_downscaling.landsat_lst_predictor import (
        EXPORT_SELECTORS,
        build_landsat_lst_predictor,
    )
    from et_downscaling.thermal_candidates import (
        annual_partitions,
